...
public class Auditorium extends Venue{
     ...
     */
    public Auditorium(String nameVenue,String venueType,int pctSeats,int capacity,double cost,int vipPct,int goldPct,int silverPct,
